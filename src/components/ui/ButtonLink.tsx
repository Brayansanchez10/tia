...
const variants = {
  primary:
    'inline-flex items-center justify-center rounded-[10px] border border-gold/50 bg-gold px-4 py-2.5 text-[0.95rem] font-semibold text-paper shadow-none no-underline transition motion-safe:duration-200 hover:brightness-110 motion-safe:hover:scale-[1.02] motion-safe:active:scale-[0.98] hover:no-underline',
  ghost:
